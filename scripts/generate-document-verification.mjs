...
const EVIDENCE = {
  ...
  'malawi.personal_number': {
    type: 'unreadable_specimen_page',
    status: 'current',
    purpose: 'document_version_not_number_format',
    url: 'https://www.consilium.europa.eu/prado/en/MWI-AO-02001/index.html',
    description: 'PRADO exact document page confirms Malawi ordinary passport MWI-AO-02001 is valid, but the accessible page does not expose a readable Personal No. field or the previously claimed 1212433/2 value.',
    observedShape: 'none',
    versionStatus: 'PRADO MWI-AO-02001 exact page; valid, first issued 01/01/2011, generated by PRADO on 01/07/2021. No readable personal-number specimen is exposed in the accessible page.',
    requiredAction: 'Production blocker: keep quality review-only or attach a readable official specimen/biodata image that exposes Personal No. value.',
  },
...
function classify(rule, evidence) {
  ...
  if (evidence.type === 'unreadable_specimen_page') return 'insufficient evidence';
